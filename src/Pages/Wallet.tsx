        ...
        {isOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className=" bg-white p-6 rounded-lg w-[95%] max-w-[28rem] dark:bg-popDark m-auto sm:mx-4">
              <h2 className="text-lg font-bold mb-4 dark:text-white">Exchange</h2>
              <div className="pb-2 mb-4 rounded-5xl">
                <div className="flex justify-between">
                  <label className="block text-sm dark:text-white">From Currency</label>
              ...
              <div className="mb-4">
                <label className="block text-sm dark:text-white">To Currency</label>
                <select
                  className="w-full border px-3 py-3 rounded-3xl mt-3 dark:bg-transparent dark:text-white"
                  value={selectedCurrency}
                  onChange={(e) => setSelectedCurrency(e.target.value)}
                >
                  <option value="" className="dark:bg-black">Select Currency</option>
                  <option value="BTC" className="dark:bg-black">BTC</option>
                  <option value="ETH" className="dark:bg-black">ETH</option>
                </select>
              </div>
              <div className="mb-4">
                <div className="flex justify-between">
              ...
              <div className="flex justify-center sm:justify-between flex-wrap gap-3 ">
                ...
                >
                  <span className="block w-full h-full px-14 py-2 rounded-md bg-white dark:bg-black dark:text-white text-black font-bold text-center transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-[#01D3FF] hover:to-[#2954A3] hover:text-white">
                    Cancel
                  </span>
                </button>

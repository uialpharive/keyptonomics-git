...
const Login = () => {
  ...
  return (
    ...
    >
      <ToastContainer />
      <div className="absolute inset-0 bg-white/70 dark:bg-[#1E2637]/10 backdrop-blur-sm z-0"></div>
  ...
  <div className="border-[3px] md:border-[3px] lg:border-[3px] rounded-lg shadow-lg xs:bg-none bg-gradient-to-r from-blue-300/40 to-blue-700/20 flex flex-col md:flex-row gap-8 xTTs:w-[473px] xTs:w-[473px] xs:mr-3 sm:w-[67%] max-w-none md:w-auto w-full border-transparent md:border-[#00cdf9] p-0 overflow-hidden">
    ...
    {/* Login Form */}
    <div className="flex flex-col bg-[#1e2637] rounded-md p-5 m-3 sm:m-2 md:m-3 lg:m-3 xl:m-4 w-full max-w-md">
      ...
      <div className="relative w-full">
        <input
          ...
          className={`p-3 h-10 w-full rounded-md mt-1 text-white border mb-3 outline-none focus:ring-2 pr-10
            ${errors?.email ? "border-red-700 bg-gray-700 focus:ring-red-700" : "border-gray-500 bg-gray-700 focus:ring-blue-500"}
          `}
        />
        {errors?.email && (
          <span className="absolute right-3 top-6 font-semibold text-red-500">
            <MdError />
          </span>
        )}
      </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="p-3 h-10 w-full rounded-md mb-4 bg-gray-700 border border-gray-500 mt-1 text-white pr-10"
        />
        <button
          type="button"
      ...
      {/* Links */}
      <a href="/forget_password" className="text-sm text-[#00cdf9] mt-4 text-center">
        Forgot password?
      </a>
      <a href="/register" className="text-sm text-gray-300 mt-4 text-center">
